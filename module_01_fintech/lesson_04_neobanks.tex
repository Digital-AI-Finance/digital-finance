...
\begin{center}
\includegraphics[width=0.75\textwidth]{figures/neobank_market_leaders.pdf}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.72\textwidth]{figures/revolut_products/revolut_products.pdf}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.70\textwidth]{figures/neobank_unit_economics.pdf}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.72\textwidth]{figures/neobank_revenue_breakdown/neobank_revenue_breakdown.pdf}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.68\textwidth]{figures/license_strategies/license_strategies.pdf}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.72\textwidth]{figures/neobank_positioning/neobank_positioning.pdf}
\end{center}
\end{frame}
