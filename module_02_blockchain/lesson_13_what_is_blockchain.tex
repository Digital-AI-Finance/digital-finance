...
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/double_spend_problem/double_spend_problem.pdf}
\end{center}
...
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/satoshi_timeline/satoshi_timeline.pdf}
\end{center}
...
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/blockchain_architecture/blockchain_architecture.pdf}
\end{center}
\bottomnote{Blockchain: a chain of cryptographically linked blocks forming an immutable ledger.}
\end{frame}

\begin{frame}[t]{Blockchain Properties}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/blockchain_properties/blockchain_properties.pdf}
\end{center}
\bottomnote{These five properties distinguish blockchain from traditional databases.}
\end{frame}

\begin{frame}[t]{Centralized vs Decentralized Systems}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/centralized_vs_decentralized/centralized_vs_decentralized.pdf}
\end{center}
...
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/blockchain_trilemma/blockchain_trilemma.pdf}
\end{center}
...
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/blockchain_use_cases/blockchain_use_cases.pdf}
\end{center}
...
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/blockchain_vs_database/blockchain_vs_database.pdf}
\end{center}
\bottomnote{Use blockchain ONLY if multiple parties need shared write access without mutual trust.}
\end{frame}
