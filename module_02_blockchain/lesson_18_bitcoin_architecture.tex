...
\begin{frame}[t]{Bitcoin System Overview}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/bitcoin_system_architecture/bitcoin_system_architecture.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{UTXO Model: Digital Cash Analogy}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/utxo_concept/utxo_concept.pdf}
\end{columns}
\bottomnote{Key concepts from this slide inform practical applications in finance.}
\end{frame}

\begin{frame}[t]{UTXO vs Account Model}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/utxo_vs_account/utxo_vs_account.pdf}
\end{center}
\vspace{-3mm}
\begin{columns}[T]
\scriptsize
...
\begin{frame}[t]{Transaction Structure: Inputs and Outputs}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/transaction_structure/transaction_structure.pdf}
\end{center}
\vspace{-3mm}
\textbf{Components:}
\begin{itemize}
...
\begin{frame}[t]{Example Transaction: Alice Pays Bob}
\vspace{-2mm}
...
\begin{center}
\includegraphics[width=0.42\textwidth]{figures/alice_to_bob_transaction/alice_to_bob_transaction.pdf}
\end{center}
\bottomnote{UTXO model: Alice's UTXO consumed, new UTXOs created for Bob and change.}
\end{frame}

\begin{frame}[t]{Transaction Chaining}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/transaction_chain/transaction_chain.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{Bitcoin Script: Programmable Conditions}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/script_execution/script_execution.pdf}
\end{columns}
\bottomnote{Bitcoin remains the largest cryptocurrency by market cap and network security.}
\end{frame}

\begin{frame}[t]{P2PKH: Standard Bitcoin Transaction}
\vspace{-2mm}
...
\begin{frame}[t]{Multisig: M-of-N Signatures}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/multisig_example/multisig_example.pdf}
\end{columns}
...
\begin{frame}[t]{Transaction Lifecycle}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/transaction_lifecycle/transaction_lifecycle.pdf}
\end{center}
\vspace{-3mm}
\textbf{Stages:}
\begin{enumerate}
...
\begin{frame}[t]{Mempool: Waiting Room for Transactions}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/mempool_visualization/mempool_visualization.pdf}
\end{columns}
\bottomnote{AI and ML are transforming financial services through automation and prediction.}
\end{frame}

\begin{frame}[t]{Transaction Fees: Mechanics}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/fee_distribution/fee_distribution.pdf}
\end{columns}
\bottomnote{Key concepts from this slide inform practical applications in finance.}
\end{frame}

\begin{frame}[t]{Fee Dynamics During Congestion}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/fee_market_congestion/fee_market_congestion.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{SegWit: Segregated Witness (2017)}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/segwit_structure/segwit_structure.pdf}
\end{columns}
\bottomnote{Key concepts from this slide inform practical applications in finance.}
\end{frame}

\begin{frame}[t]{Lightning Network: Layer 2 Scaling}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/lightning_network_concept/lightning_network_concept.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{Lightning Payment Channel Mechanics}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/lightning_channel/lightning_channel.pdf}
\end{columns}
...
\begin{frame}[t]{Lightning Network Routing}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/lightning_routing/lightning_routing.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{Lightning vs On-Chain Comparison}
\vspace{-2mm}
\begin{center}
...
\begin{frame}[t]{Taproot Upgrade (2021)}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/taproot_comparison/taproot_comparison.pdf}
\end{columns}
\bottomnote{Key concepts from this slide inform practical applications in finance.}
\end{frame}

\begin{frame}[t]{Bitcoin Full Node}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/node_types/node_types.pdf}
\end{columns}
\bottomnote{Bitcoin remains the largest cryptocurrency by market cap and network security.}
\end{frame}
