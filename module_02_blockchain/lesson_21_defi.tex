...
\begin{frame}[t]{DeFi: Decentralized Finance Revolution}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/tradfi_vs_defi/tradfi_vs_defi.pdf}
\end{columns}
\bottomnote{Understanding history helps predict future developments in the technology.}
\end{frame}

\begin{frame}[t]{DeFi Primitives}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/defi_stack/defi_stack.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{Decentralized Exchanges (DEXs): The Problem}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/orderbook_gas_costs/orderbook_gas_costs.pdf}
\end{columns}
\bottomnote{Centralized systems trade trust for efficiency; decentralized systems trade efficiency for trustlessness.}
\end{frame}

\begin{frame}[t]{AMM: Automated Market Maker}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/amm_concept/amm_concept.pdf}
\end{center}
\vspace{-3mm}
\textbf{Key Idea:}
\begin{itemize}
...
\begin{frame}[t]{Constant Product Formula: $x \times y = k$}
\vspace{-2mm}
...
\begin{frame}[t]{AMM Bonding Curve Visualization}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/bonding_curve/bonding_curve.pdf}
\end{center}
\vspace{-3mm}
\textbf{Properties:}
\begin{itemize}
...
\begin{frame}[t]{Price Impact and Slippage}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/slippage_curve/slippage_curve.pdf}
\end{columns}
...
\begin{frame}[t]{Liquidity Providers: Earning Fees}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/liquidity_provision/liquidity_provision.pdf}
\end{columns}
\bottomnote{Key concepts from this slide inform practical applications in finance.}
\end{frame}

\begin{frame}[t]{Impermanent Loss: The Hidden Cost}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/impermanent_loss/impermanent_loss.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{Impermanent Loss Formula}
\vspace{-2mm}
\textbf{Exact Formula:}
\[
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/uniswap_v3_ranges/uniswap_v3_ranges.pdf}
\end{columns}
\bottomnote{Key concepts from this slide inform practical applications in finance.}
\end{frame}

\begin{frame}[t]{Lending Protocols: Aave and Compound}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/lending_protocol_architecture/lending_protocol_architecture.pdf}
\end{center}
\vspace{-3mm}
\textbf{Mechanism:}
\begin{itemize}
...
\begin{frame}[t]{Over-Collateralization Requirement}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/collateral_ratio/collateral_ratio.pdf}
\end{columns}
...
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/interest_rate_curve/interest_rate_curve.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{Flash Loans: Zero-Collateral Instant Loans}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/flash_loan_flow/flash_loan_flow.pdf}
\end{columns}
\bottomnote{Key concepts from this slide inform practical applications in finance.}
\end{frame}

\begin{frame}[t]{Flash Loan Attack Example}
\vspace{-2mm}
...
\begin{frame}[t]{Yield Farming: Chasing Returns}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/yield_farming_stack/yield_farming_stack.pdf}
\end{columns}
\bottomnote{Key concepts from this slide inform practical applications in finance.}
\end{frame}

\begin{frame}[t]{DeFi Summer 2020: Liquidity Mining Explosion}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/defi_tvl_history/defi_tvl_history.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{DeFi vs CeFi: Trade-offs}
\vspace{-2mm}
\begin{center}
