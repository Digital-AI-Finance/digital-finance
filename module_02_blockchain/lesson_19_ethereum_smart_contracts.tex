...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{charts/lesson_19/bitcoin_vs_ethereum.pdf}
\end{columns}
\end{frame}

\begin{frame}{Smart Contracts: Code as Law}
\begin{center}
\includegraphics[width=0.85\textwidth]{charts/lesson_19/smart_contract_concept.pdf}
\end{center}
\vspace{-3mm}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{charts/lesson_19/account_types.pdf}
\end{columns}
...
\begin{center}
\includegraphics[width=0.85\textwidth]{charts/lesson_19/evm_architecture.pdf}
\end{center}
\vspace{-3mm}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{charts/lesson_19/gas_mechanism.pdf}
\end{columns}
\end{frame}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{charts/lesson_19/legacy_fee_market.pdf}
\end{columns}
\end{frame}

\begin{frame}{EIP-1559: Fee Market Reform (August 2021)}
\begin{center}
\includegraphics[width=0.85\textwidth]{charts/lesson_19/eip1559_structure.pdf}
\end{center}
\vspace{-3mm}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{charts/lesson_19/base_fee_adjustment.pdf}
\end{columns}
\end{frame}

\begin{frame}{Fee Burning: Deflationary Pressure}
\begin{center}
\includegraphics[width=0.85\textwidth]{charts/lesson_19/eth_issuance_burn.pdf}
\end{center}
\vspace{-3mm}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{charts/lesson_19/solidity_example.pdf}
\end{center}
\vspace{-3mm}
\textbf{Key Features:}
\begin{itemize}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{charts/lesson_19/contract_lifecycle.pdf}
\end{center}
\vspace{-3mm}
\textbf{Stages:}
\begin{enumerate}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{charts/lesson_19/storage_vs_memory.pdf}
\end{columns}
\end{frame}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{charts/lesson_19/events_architecture.pdf}
\end{columns}
\end{frame}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{charts/lesson_19/external_call_flow.pdf}
\end{columns}
\end{frame}

\begin{frame}{Reentrancy: The DAO Hack (2016)}
\begin{center}
\includegraphics[width=0.85\textwidth]{charts/lesson_19/reentrancy_attack.pdf}
\end{center}
\vspace{-3mm}
\textbf{Vulnerability:}
\begin{itemize}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{charts/lesson_19/oracle_architecture.pdf}
\end{columns}
...
\begin{center}
\includegraphics[width=0.85\textwidth]{charts/lesson_19/proxy_pattern.pdf}
\end{center}
\vspace{-3mm}
\textbf{Design:}
\begin{itemize}
