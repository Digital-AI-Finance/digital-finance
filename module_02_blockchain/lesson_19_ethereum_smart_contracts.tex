...
\begin{frame}[t]{Bitcoin's Limitations: Why Ethereum?}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
...
\begin{frame}[t]{Smart Contracts: Code as Law}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.45\textwidth]{figures/smart_contract_concept/smart_contract_concept.pdf}
\end{center}
\vspace{-4mm}
{\small\textbf{Definition:} Self-executing programs stored on blockchain, automatically enforcing agreements}

\vspace{1mm}
{\small\textbf{Properties:}}
\begin{itemize}
\item Deterministic execution (same input $\rightarrow$ same output)
\item Immutable once deployed
\item Transparent and trustless
\end{itemize}
\bottomnote{Smart contracts enable programmable, self-executing agreements without intermediaries.}
\end{frame}

\begin{frame}[t]{Account Model: Ethereum's Design}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Gas: Metering Computation}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Gas Costs: Operation Examples}
\vspace{-2mm}
\begin{center}
...
\begin{frame}[t]{Transaction Cost Calculation}
\vspace{-2mm}
...
\begin{frame}[t]{Legacy Fee Market: First-Price Auction}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{EIP-1559: Fee Market Reform (August 2021)}
\vspace{-2mm}
\begin{center}
...
\begin{frame}[t]{EIP-1559 Base Fee Dynamics}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Fee Burning: Deflationary Pressure}
\vspace{-2mm}
\begin{center}
...
\begin{frame}[t]{Solidity: High-Level Smart Contract Language}
\vspace{-2mm}
...
\begin{frame}[t]{Contract Storage: Persistent State}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{External Calls: Composability and Risks}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Oracles: Bridging On-Chain and Off-Chain}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Gas Optimization Strategies}
\vspace{-2mm}
\begin{itemize}
...
\begin{frame}[t]{Upgradeable Contracts: Proxy Pattern}
\vspace{-2mm}
\begin{center}
