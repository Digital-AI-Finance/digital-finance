...
\begin{frame}[t]{Simple Linear Regression: The Basics}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{Model:}
\[
...
\begin{frame}[t]{Overfitting: The Central Problem in ML}
\begin{columns}[T]
\column{0.48\textwidth}
...
\textbf{Best Practice:} Start linear as baseline, try non-linear if poor fit
\end{columns}
