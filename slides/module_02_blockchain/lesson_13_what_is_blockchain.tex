...
\begin{frame}{The Trust Problem in Digital Transactions}
\vspace{-2mm}
\begin{columns}[T]
...
\begin{frame}{The Evolution of Digital Cash}
\vspace{-2mm}
\begin{table}[h]
\centering
\small
...
\begin{frame}{Satoshi Nakamoto's Breakthrough (October 2008)}
\vspace{-2mm}
\begin{columns}[T]
...
\begin{frame}{What is a Blockchain? Core Definition}
\vspace{-2mm}
...
\begin{frame}{Centralized vs Decentralized Systems}
\vspace{-2mm}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{How Blockchain Works: Simplified Flow}
\vspace{-2mm}
...
\begin{frame}{Public vs Private Blockchains}
\vspace{-2mm}
\begin{table}[h]
\centering
\small
...
\begin{frame}{Blockchain Use Cases Beyond Cryptocurrency}
\vspace{-2mm}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Real-World Example: Walmart Food Traceability}
\vspace{-2mm}
...
\begin{frame}{Blockchain vs Traditional Database}
\vspace{-2mm}
\begin{table}[h]
\centering
\footnotesize
...
\begin{frame}{The Hype Cycle: Where Are We?}
\vspace{-2mm}
...
\begin{frame}{Bitcoin Network Statistics (2024)}
\vspace{-2mm}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Ethereum Network Statistics (2024)}
\vspace{-2mm}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Key Terminology Summary}
\vspace{-2mm}
\begin{multicols}{2}
\footnotesize
