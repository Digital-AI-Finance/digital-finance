...
\begin{frame}[t]{The Stakes: Billions Lost to Hacks}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/crypto_hacks_timeline/crypto_hacks_timeline.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{Threat Landscape}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/threat_categories/threat_categories.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{Reentrancy: The DAO Hack (2016)}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/reentrancy_flow/reentrancy_flow.pdf}
\end{columns}
...
\begin{frame}[t]{Reentrancy Code Example}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.55\textwidth]{figures/reentrancy_code/reentrancy_code.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{Integer Overflow/Underflow}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/overflow_visualization/overflow_visualization.pdf}
\end{columns}
...
\begin{frame}[t]{Access Control Vulnerabilities}
\vspace{-2mm}
...
\begin{frame}[t]{Oracle Manipulation: Flash Loan Attacks}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/flash_loan_attack/flash_loan_attack.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{Oracle Security: Defense Mechanisms}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/oracle_comparison/oracle_comparison.pdf}
\end{columns}
...
\begin{frame}[t]{Bridge Hacks: Cross-Chain Vulnerabilities}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/bridge_architecture/bridge_architecture.pdf}
\end{columns}
\bottomnote{AI and ML are transforming financial services through automation and prediction.}
\end{frame}

\begin{frame}[t]{Ronin Bridge Hack (2022): \$625M Stolen}
\vspace{-2mm}
\textbf{Context:}
\begin{itemize}
...
\begin{frame}[t]{Wormhole Bridge Hack (2022): \$325M}
\vspace{-2mm}
\textbf{Mechanism:}
\begin{itemize}
...
\begin{frame}[t]{Bridge Hacks: Total Damage}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.48\textwidth]{figures/bridge_hacks_chart/bridge_hacks_chart.pdf}
\end{center}
\vspace{-3mm}
...
\begin{frame}[t]{Phishing and Social Engineering}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/phishing_flow/phishing_flow.pdf}
\end{columns}
\bottomnote{Key concepts from this slide inform practical applications in finance.}
\end{frame}

\begin{frame}[t]{Address Poisoning Attack}
\vspace{-2mm}
\begin{center}
\includegraphics[width=0.55\textwidth]{figures/address_poisoning/address_poisoning.pdf}
\end{center}
\vspace{-3mm}
\textbf{Attack:}
\begin{enumerate}
...
\begin{frame}[t]{Rug Pulls: Exit Scams}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/rug_pull_pattern/rug_pull_pattern.pdf}
\end{columns}
...
\begin{frame}[t]{Governance Attacks}
\vspace{-2mm}
\textbf{Scenario:}
\begin{itemize}
...
\begin{frame}[t]{Auditing: Not a Silver Bullet}
\vspace{-2mm}
\textbf{Audit Process:}
\begin{itemize}
...
\begin{frame}[t]{Bug Bounties: Whitehat Incentives}
\vspace{-2mm}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\includegraphics[width=\textwidth]{figures/bug_bounty_tiers/bug_bounty_tiers.pdf}
\end{columns}
