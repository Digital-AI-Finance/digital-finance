...
\begin{frame}[t]{Compliance Cost Trends}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/compliance_costs/compliance_costs.pdf}
\end{center}
\bottomnote{Compliance costs have grown substantially post-financial crisis.}
\end{frame}

\begin{frame}[t]{Regulatory Fines and Penalties}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/regulatory_fines/regulatory_fines.pdf}
\end{center}
\bottomnote{Regulatory fines for non-compliance can reach billions of dollars.}
\end{frame}
...
\begin{frame}[t]{AML Transaction Monitoring}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/aml_transaction_monitoring/aml_transaction_monitoring.pdf}
\end{center}
\bottomnote{Transaction monitoring systems screen billions of transactions for suspicious patterns.}
\end{frame}

\begin{frame}[t]{KYC Process Workflow}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/kyc_process/kyc_process.pdf}
\end{center}
\bottomnote{KYC processes balance customer onboarding speed with risk management.}
\end{frame}
