...
\begin{frame}{RegTech Definition and Scope}
\begin{columns}[T]
...
\begin{frame}{Basel III Overview}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Risk-Weighted Assets (RWA) Calculation}
\begin{columns}[T]
\column{0.48\textwidth}
...
\vspace{1mm}
$$K = [\text{LGD} \times N(\sqrt{\frac{1}{1-R}} \cdot N^{-1}(\text{PD}) + \sqrt{\frac{R}{1-R}} \cdot N^{-1}(0.999)) - \text{PD} \times \text{LGD}] \times (1 + (M-2.5) \times b)$$

where $R$ = correlation, $M$ = maturity
...
\begin{frame}{Liquidity Requirements: LCR and NSFR}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{IFRS 9 Overview and ECL Model}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{SICR Criteria and Implementation}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Macroeconomic Scenarios and Probability Weighting}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{EMIR Trade Reporting}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{MiFID II Reporting and Transaction Monitoring}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{US Regulatory Reporting (Dodd-Frank)}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{KYC and Customer Due Diligence}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Transaction Monitoring and AML}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Sanctions Screening and Trade Surveillance}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{SupTech and Machine-Readable Regulation}
\begin{columns}[T]
\column{0.48\textwidth}
