...
\begin{frame}[t]{VaR Distribution Histogram}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/var_histogram/var_histogram.pdf}
\end{center}
\bottomnote{VaR quantifies potential losses at a given confidence level.}
\end{frame}

\begin{frame}[t]{VaR Definition and Framework}
\begin{columns}[T]
\scriptsize
...
\begin{frame}[t]{VaR Methodologies}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{VaR Backtesting and Model Validation}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Limitations of VaR and Alternatives}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Financial Risk Types}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/risk_types/risk_types.pdf}
\end{center}
\bottomnote{Financial institutions face multiple categories of risk requiring specialized management.}
\end{frame}

\section{Stress Testing and Scenario Analysis}

\begin{frame}[t]{Stress Testing Framework}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/stress_testing/stress_testing.pdf}
\end{center}
\bottomnote{Stress tests evaluate resilience under extreme but plausible scenarios.}
\end{frame}
...
\begin{frame}[t]{Historical Crisis Scenarios}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Reverse Stress Testing}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
\textbf{Methodology:}
...
\begin{frame}[t]{Model Risk Framework}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Model Validation Process}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Model Risk in Machine Learning}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{ERM System Architecture}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Risk Aggregation Challenges}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Real-Time Risk Management}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Basel Capital Requirements}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/basel_capital/basel_capital.pdf}
\end{center}
\bottomnote{Basel frameworks define minimum capital requirements for credit risk.}
\end{frame}

\begin{frame}[t]{Credit Rating Distribution}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/credit_rating_distribution/credit_rating_distribution.pdf}
\end{center}
\bottomnote{Credit ratings provide standardized assessment of default probability.}
\end{frame}

\section{Regulatory Capital and Risk Metrics}

\begin{frame}[t]{Basel III Market Risk Framework}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}[t]{Counterparty Credit Risk Metrics}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
