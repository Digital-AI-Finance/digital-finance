...
\begin{frame}{Derivatives Market Landscape}
\begin{columns}[T]
\scriptsize
...
\begin{frame}{Derivatives Product Types}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
\textbf{Futures:}
...
\begin{frame}{Derivatives Pricing Models}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}{Greeks and Risk Management}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}{Derivatives Valuation Systems}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}{Futures Trading Platforms}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}{Options Trading and Volatility Markets}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}{OTC Derivatives Lifecycle}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
\textbf{Pre-Trade:}
...
\begin{frame}{Central Counterparty Clearing (CCPs)}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}{Margin and Collateral Systems}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}{EMIR Reporting Requirements}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}{Dodd-Frank Swap Data Reporting}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}{SOFR Transition and IBOR Reform}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
...
\begin{frame}{DLT and Smart Derivatives Contracts}
\begin{columns}[T]
\scriptsize
\column{0.48\textwidth}
