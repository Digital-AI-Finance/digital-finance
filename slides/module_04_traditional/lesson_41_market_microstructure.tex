...
\begin{frame}{Microstructure Theory Overview}
\begin{columns}[T]
...
\begin{frame}{Bid-Ask Spread Fundamentals}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Adverse Selection and Information Models}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Market Maker Role and Economics}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Inventory Management Models}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{itemize}
\item Machine learning for arrival rate prediction
\item Multi-venue inventory optimization
\item Reinforcement learning for quote placement
\end{itemize}
\end{columns}
\end{frame}

\begin{frame}{Payment for Order Flow (PFOF)}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{HFT Definition and Characteristics}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{HFT Market Impact Debate}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{May 6, 2010 Flash Crash}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Other Notable Flash Events}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Market Stability Mechanisms}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Intraday Patterns and Anomalies}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Tick Size and Market Quality}
\begin{columns}[T]
\column{0.48\textwidth}
