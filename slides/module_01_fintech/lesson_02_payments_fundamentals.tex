...
\begin{frame}{Payment Fundamentals: Overview}
\begin{columns}[T]
...
\begin{frame}{Payment Lifecycle: Four Stages}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Card Payment Flow: Step-by-Step}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Card Networks: Visa and Mastercard}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{Visa Inc:}
\begin{itemize}
...
\begin{frame}{Interchange Fees: The Hidden Economy}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Merchant Discount Rate (MDR): Total Cost}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{itemize}
\item \EUR100 credit card purchase (EU)
\item Interchange: \EUR0.30 (0.3\% cap)
\item Network fee: \EUR0.14 (0.14\%)
\item Acquirer margin: \EUR0.25 (0.25\%)
\item Total MDR: \EUR0.69 (0.69\%)
\item Merchant receives: \EUR99.31
\end{itemize}
...
\begin{frame}{Interchange Fee Regulation}
\begin{columns}[T]
\column{0.48\textwidth}
...
\item Saved merchants \EUR1.2B annually
\end{itemize}
...
\begin{frame}{ACH: Automated Clearing House}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{What is ACH?}
\begin{itemize}
...
\begin{frame}{SEPA: Single Euro Payments Area}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{What is SEPA?}
\begin{itemize}
...
\item Limit: \EUR100,000 per transaction (raised from \EUR15k in 2024)
...
\begin{frame}{Payment Processing Value Chain}
\begin{columns}[T]
\column{0.48\textwidth}
...
\item Adyen: \EUR786B TPV (2023), unified platform
...
\begin{frame}{Payment Security: PCI DSS}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Payment Fraud: Types and Prevention}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{Fraud Types:}
\begin{itemize}
...
\begin{frame}{Chargebacks: Process and Impact}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Real-Time Payments: Global Overview}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{FedNow: US Real-Time Payments}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Payment Method Comparison}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{Cards:}
\begin{itemize}
