...
\begin{frame}
\titlepage
\bottomnote{Credit scoring affects billions of lending decisions annually.}
\end{frame}
...
\bottomnote{FICO scores range 300-850 with most lenders requiring 620+ for prime rates.}
\end{frame}
