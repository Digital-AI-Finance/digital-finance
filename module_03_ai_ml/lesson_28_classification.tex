...
\begin{frame}
\titlepage
\bottomnote{Classification assigns categories - essential for credit and fraud decisions.}
\end{frame}
...
\end{itemize}
\bottomnote{ROC curves show classifier performance across all threshold choices.}
\end{frame}
