...
\begin{frame}
\titlepage
\bottomnote{Regression predicts continuous values - the foundation of quantitative finance.}
\end{frame}
...
\end{itemize}
\end{columns}
\bottomnote{The bias-variance tradeoff is fundamental - models must balance underfitting and overfitting.}
\end{frame}
...
\end{itemize}
\bottomnote{Confusion matrices reveal error types - critical when false positives/negatives have different costs.}
\end{frame}
