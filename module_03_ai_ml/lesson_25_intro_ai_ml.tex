...
\begin{frame}
\titlepage
\bottomnote{Module 3 of 4: AI and Machine Learning in Finance}
\end{frame}
...
\end{itemize}
\bottomnote{These concepts form the foundation for practical applications in finance.}
\end{frame}

\begin{frame}[t]{What is Artificial Intelligence?}
\begin{columns}[T]
...
\begin{frame}[t]{The AI Hierarchy: From Broad to Narrow}
\begin{columns}[T]
\column{0.48\textwidth}
...
\column{0.48\textwidth}
\begin{center}
\includegraphics[width=0.95\textwidth]{figures/ai_hierarchy/ai_hierarchy.pdf}
\end{center}
\end{columns}
\bottomnote{AI and ML are transforming financial services through automation and prediction.}
\end{frame}

\begin{frame}[t]{Machine Learning: The Core Idea}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}[t]{Three Types of Machine Learning}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/ml_types/ml_types.pdf}
\end{center}
\bottomnote{Supervised learning dominates financial applications due to availability of labeled data.}
\end{frame}

\begin{frame}[t]{Deep Learning: Neural Networks at Scale}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}[t]{AI/ML Applications in Finance: Overview}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/ai_finance_applications/ai_finance_applications.pdf}
\end{center}
\vspace{0.5em}
\textbf{Common Thread:} Automation of pattern recognition tasks previously requiring human expertise.
\bottomnote{Real-world applications demonstrate the practical value of AI/ML in finance.}
\end{frame}

\begin{frame}[t]{Case Study: Credit Scoring Evolution}
\begin{columns}[T]
\column{0.48\textwidth}
...
\bottomnote{AI encompasses ML which includes deep learning - understanding this hierarchy clarifies terminology.}
\end{frame}

\begin{frame}[t]{The Hype Cycle: Expectations vs Reality}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}[t]{What AI/ML Can and Cannot Do in Finance}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{Can Do Well:}
\begin{itemize}
...
\begin{frame}[t]{Historical Timeline: AI in Finance}
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/ml_finance_timeline/ml_finance_timeline.pdf}
\end{center}
\bottomnote{AI evolution in finance shows accelerating adoption from expert systems to generative AI.}
\end{frame}

\begin{frame}[t]{Industry Adoption: Survey Data}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}[t]{Key Players and Ecosystem}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}[t]{Data: The Fuel for AI/ML}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}[t]{Skills for AI/ML in Finance}
\begin{columns}[T]
\column{0.48\textwidth}
...
\end{itemize}
\end{columns}
\bottomnote{Overfitting produces excellent in-sample fit but poor out-of-sample predictions.}
\end{frame}
