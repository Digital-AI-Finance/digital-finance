"""
Run all Module 04 chart scripts to generate PDFs
"""
...
def run_all_charts():
    module_path = Path(__file__).parent / 'module_04_trad_finance' / 'figures'
    ...
    print(f"Found {len(chart_folders)} chart folders in module_04_trad_finance")
    print("=" * 60)
