...
\begin{frame}{Evolution of Trading Technology}
\begin{columns}[T]
...
\begin{frame}{Electronic Trading System Architecture}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Advanced Order Types}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Algorithmic Order Types}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Electronic Order Book Structure}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Price-Time Priority Matching}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Order Book Dynamics and Toxicity}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Smart Order Router (SOR) Architecture}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Venue Fragmentation and Best Execution}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Dark Pool Types and Mechanics}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Trading Regulation and Surveillance}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Pre-Trade and Post-Trade Risk Controls}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{frame}{Notable Trading Incidents}
\begin{columns}[T]
\column{0.48\textwidth}
